...
from synth_fl.libs.flsim.clients.base_client import Client
from synth_fl.libs.flsim.clients.dp_client import DPClient, DPClientConfig
...
from synth_fl.libs.flsim.servers.sync_dp_servers import SyncDPSGDServer
from synth_fl.libs.flsim.servers.sync_secagg_servers import SyncSecAggServer
from synth_fl.libs.flsim.servers.sync_servers import (
...
from synth_fl.libs.flsim.utils.fl.stats import RandomVariableStatsTracker
...
class SyncTrainer(FLTrainer):
    ...
    def _train_one_round(
        ...
        self._post_train_one_round(timeline, metrics_reporter=metrics_reporter)
    ...
    def _post_train_one_round(self, timeline: Timeline, **kwargs):
