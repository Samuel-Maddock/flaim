...
class GraphicalModel:
    def __init__(
        self, domain, cliques, total=1.0, elimination_order=None, size_only=False
    ):
    ...
    def synthetic_data(self, rows=None):
        ...
        def synthetic_col(counts, total):
            counts *= total / counts.sum()  # normalises marginal
        ...
        return Dataset(df, self.domain), df


# Variable elim - Alg3 in paper
